...
public class ChooseAreaActivity extends Activity {
    ...
    private static final String ADDRESS = "https://api.heweather.com/x3/citylist?search=allchina&key=6ed06449493d4eb093bbd8f270020850";
        ...
        HttpUtil.sendHttpRequest(ADDRESS, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    ...
                    result = Utility.handleCitiesResponse(code, coolWeatherDB, response, selectedProvince.getId());
                } else if ("county".equals(type)) {
                    result = Utility.handleCountiesResponse(code, coolWeatherDB, response, selectedCity.getId());
                }
                if (result) {
